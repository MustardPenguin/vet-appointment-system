...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6132221736172522497L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Value\",\"namespace\":\"transaction_created.payment.payment_outbox\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"created_at\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.MicroTimestamp\"}},{\"name\":\"payload\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Json\"}},{\"name\":\"version\",\"type\":\"int\"}],\"connect.name\":\"transaction_created.payment.payment_outbox.Value\"}");
   ...
   */
  public static transaction_created.payment.payment_outbox.Value.Builder newBuilder() {
    return new transaction_created.payment.payment_outbox.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static transaction_created.payment.payment_outbox.Value.Builder newBuilder(transaction_created.payment.payment_outbox.Value.Builder other) {
    if (other == null) {
      return new transaction_created.payment.payment_outbox.Value.Builder();
    } else {
      return new transaction_created.payment.payment_outbox.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static transaction_created.payment.payment_outbox.Value.Builder newBuilder(transaction_created.payment.payment_outbox.Value other) {
    if (other == null) {
      return new transaction_created.payment.payment_outbox.Value.Builder();
    } else {
      return new transaction_created.payment.payment_outbox.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(transaction_created.payment.payment_outbox.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(transaction_created.payment.payment_outbox.Value other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public transaction_created.payment.payment_outbox.Value.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public transaction_created.payment.payment_outbox.Value.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public transaction_created.payment.payment_outbox.Value.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public transaction_created.payment.payment_outbox.Value.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public transaction_created.payment.payment_outbox.Value.Builder setPayload(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public transaction_created.payment.payment_outbox.Value.Builder clearPayload() {
      payload = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public transaction_created.payment.payment_outbox.Value.Builder setVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public transaction_created.payment.payment_outbox.Value.Builder clearVersion() {
