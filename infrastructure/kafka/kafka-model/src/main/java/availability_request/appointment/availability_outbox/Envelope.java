 ...
 */
package availability_request.appointment.availability_outbox;
...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private availability_request.appointment.availability_outbox.Value before;
  private availability_request.appointment.availability_outbox.Value after;
   ...
   */
  public Envelope(availability_request.appointment.availability_outbox.Value before, availability_request.appointment.availability_outbox.Value after, io.debezium.connector.postgresql.Source source, java.lang.String op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (availability_request.appointment.availability_outbox.Value)value$; break;
    case 1: after = (availability_request.appointment.availability_outbox.Value)value$; break;
   ...
   */
  public availability_request.appointment.availability_outbox.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(availability_request.appointment.availability_outbox.Value value) {
    this.before = value;
  }
   ...
   */
  public availability_request.appointment.availability_outbox.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(availability_request.appointment.availability_outbox.Value value) {
    this.after = value;
  }
   ...
   */
  public static availability_request.appointment.availability_outbox.Envelope.Builder newBuilder() {
    return new availability_request.appointment.availability_outbox.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static availability_request.appointment.availability_outbox.Envelope.Builder newBuilder(availability_request.appointment.availability_outbox.Envelope.Builder other) {
    if (other == null) {
      return new availability_request.appointment.availability_outbox.Envelope.Builder();
    } else {
      return new availability_request.appointment.availability_outbox.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static availability_request.appointment.availability_outbox.Envelope.Builder newBuilder(availability_request.appointment.availability_outbox.Envelope other) {
    if (other == null) {
      return new availability_request.appointment.availability_outbox.Envelope.Builder();
    } else {
      return new availability_request.appointment.availability_outbox.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private availability_request.appointment.availability_outbox.Value before;
    private availability_request.appointment.availability_outbox.Value.Builder beforeBuilder;
    private availability_request.appointment.availability_outbox.Value after;
    private availability_request.appointment.availability_outbox.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(availability_request.appointment.availability_outbox.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = availability_request.appointment.availability_outbox.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = availability_request.appointment.availability_outbox.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(availability_request.appointment.availability_outbox.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder setBefore(availability_request.appointment.availability_outbox.Value value) {
     ...
     * @return This builder.
     */
    public availability_request.appointment.availability_outbox.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(availability_request.appointment.availability_outbox.Value.newBuilder(before));
        } else {
          setBeforeBuilder(availability_request.appointment.availability_outbox.Value.newBuilder());
        }
      }
    ...
    public availability_request.appointment.availability_outbox.Envelope.Builder setBeforeBuilder(availability_request.appointment.availability_outbox.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder setAfter(availability_request.appointment.availability_outbox.Value value) {
     ...
     * @return This builder.
     */
    public availability_request.appointment.availability_outbox.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(availability_request.appointment.availability_outbox.Value.newBuilder(after));
        } else {
          setAfterBuilder(availability_request.appointment.availability_outbox.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public availability_request.appointment.availability_outbox.Envelope.Builder setAfterBuilder(availability_request.appointment.availability_outbox.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public availability_request.appointment.availability_outbox.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder setTransaction(event.block value) {
    ...
    public availability_request.appointment.availability_outbox.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_request.appointment.availability_outbox.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (availability_request.appointment.availability_outbox.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (availability_request.appointment.availability_outbox.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new availability_request.appointment.availability_outbox.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new availability_request.appointment.availability_outbox.Value();
        }
