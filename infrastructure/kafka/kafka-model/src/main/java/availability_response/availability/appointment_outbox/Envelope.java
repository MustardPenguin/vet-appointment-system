 ...
 */
package availability_response.availability.appointment_outbox;
...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8973835844096950441L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Envelope\",\"namespace\":\"availability_response.availability.appointment_outbox\",\"fields\":[{\"name\":\"before\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Value\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"saga_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"created_at\",\"type\":{\"type\":\"long\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.MicroTimestamp\"}},{\"name\":\"payload\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Json\"}},{\"name\":\"version\",\"type\":\"int\"}],\"connect.name\":\"debezium.availability.appointment_outbox.Value\"}],\"default\":null},{\"name\":\"after\",\"type\":[\"null\",\"Value\"],\"default\":null},{\"name\":\"source\",\"type\":{\"type\":\"record\",\"name\":\"Source\",\"namespace\":\"io.debezium.connector.postgresql\",\"fields\":[{\"name\":\"version\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"connector\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"ts_ms\",\"type\":\"long\"},{\"name\":\"snapshot\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"true,last,false,incremental\"},\"connect.default\":\"false\",\"connect.name\":\"io.debezium.data.Enum\"},\"null\"],\"default\":\"false\"},{\"name\":\"db\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"sequence\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"schema\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"table\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"txId\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"lsn\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"xmin\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.name\":\"io.debezium.connector.postgresql.Source\"}},{\"name\":\"op\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"ts_ms\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"transaction\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"block\",\"namespace\":\"event\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"total_order\",\"type\":\"long\"},{\"name\":\"data_collection_order\",\"type\":\"long\"}],\"connect.version\":1,\"connect.name\":\"event.block\"}],\"default\":null}],\"connect.version\":1,\"connect.name\":\"debezium.availability.appointment_outbox.Envelope\"}");
  ...
  private availability_response.availability.appointment_outbox.Value before;
  private availability_response.availability.appointment_outbox.Value after;
   ...
   */
  public Envelope(availability_response.availability.appointment_outbox.Value before, availability_response.availability.appointment_outbox.Value after, io.debezium.connector.postgresql.Source source, java.lang.String op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (availability_response.availability.appointment_outbox.Value)value$; break;
    case 1: after = (availability_response.availability.appointment_outbox.Value)value$; break;
   ...
   */
  public availability_response.availability.appointment_outbox.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(availability_response.availability.appointment_outbox.Value value) {
    this.before = value;
  }
   ...
   */
  public availability_response.availability.appointment_outbox.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(availability_response.availability.appointment_outbox.Value value) {
    this.after = value;
  }
   ...
   */
  public static availability_response.availability.appointment_outbox.Envelope.Builder newBuilder() {
    return new availability_response.availability.appointment_outbox.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static availability_response.availability.appointment_outbox.Envelope.Builder newBuilder(availability_response.availability.appointment_outbox.Envelope.Builder other) {
    if (other == null) {
      return new availability_response.availability.appointment_outbox.Envelope.Builder();
    } else {
      return new availability_response.availability.appointment_outbox.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static availability_response.availability.appointment_outbox.Envelope.Builder newBuilder(availability_response.availability.appointment_outbox.Envelope other) {
    if (other == null) {
      return new availability_response.availability.appointment_outbox.Envelope.Builder();
    } else {
      return new availability_response.availability.appointment_outbox.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private availability_response.availability.appointment_outbox.Value before;
    private availability_response.availability.appointment_outbox.Value.Builder beforeBuilder;
    private availability_response.availability.appointment_outbox.Value after;
    private availability_response.availability.appointment_outbox.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(availability_response.availability.appointment_outbox.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = availability_response.availability.appointment_outbox.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = availability_response.availability.appointment_outbox.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(availability_response.availability.appointment_outbox.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder setBefore(availability_response.availability.appointment_outbox.Value value) {
     ...
     * @return This builder.
     */
    public availability_response.availability.appointment_outbox.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(availability_response.availability.appointment_outbox.Value.newBuilder(before));
        } else {
          setBeforeBuilder(availability_response.availability.appointment_outbox.Value.newBuilder());
        }
      }
    ...
    public availability_response.availability.appointment_outbox.Envelope.Builder setBeforeBuilder(availability_response.availability.appointment_outbox.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder setAfter(availability_response.availability.appointment_outbox.Value value) {
     ...
     * @return This builder.
     */
    public availability_response.availability.appointment_outbox.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(availability_response.availability.appointment_outbox.Value.newBuilder(after));
        } else {
          setAfterBuilder(availability_response.availability.appointment_outbox.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public availability_response.availability.appointment_outbox.Envelope.Builder setAfterBuilder(availability_response.availability.appointment_outbox.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public availability_response.availability.appointment_outbox.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder setTransaction(event.block value) {
    ...
    public availability_response.availability.appointment_outbox.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public availability_response.availability.appointment_outbox.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (availability_response.availability.appointment_outbox.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (availability_response.availability.appointment_outbox.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new availability_response.availability.appointment_outbox.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new availability_response.availability.appointment_outbox.Value();
        }
