...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private payment_request.appointment.payment_outbox.Value before;
  private payment_request.appointment.payment_outbox.Value after;
   ...
   */
  public Envelope(payment_request.appointment.payment_outbox.Value before, payment_request.appointment.payment_outbox.Value after, io.debezium.connector.postgresql.Source source, java.lang.String op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (payment_request.appointment.payment_outbox.Value)value$; break;
    case 1: after = (payment_request.appointment.payment_outbox.Value)value$; break;
   ...
   */
  public payment_request.appointment.payment_outbox.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(payment_request.appointment.payment_outbox.Value value) {
    this.before = value;
  }
   ...
   */
  public payment_request.appointment.payment_outbox.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(payment_request.appointment.payment_outbox.Value value) {
    this.after = value;
  }
   ...
   */
  public static payment_request.appointment.payment_outbox.Envelope.Builder newBuilder() {
    return new payment_request.appointment.payment_outbox.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static payment_request.appointment.payment_outbox.Envelope.Builder newBuilder(payment_request.appointment.payment_outbox.Envelope.Builder other) {
    if (other == null) {
      return new payment_request.appointment.payment_outbox.Envelope.Builder();
    } else {
      return new payment_request.appointment.payment_outbox.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static payment_request.appointment.payment_outbox.Envelope.Builder newBuilder(payment_request.appointment.payment_outbox.Envelope other) {
    if (other == null) {
      return new payment_request.appointment.payment_outbox.Envelope.Builder();
    } else {
      return new payment_request.appointment.payment_outbox.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private payment_request.appointment.payment_outbox.Value before;
    private payment_request.appointment.payment_outbox.Value.Builder beforeBuilder;
    private payment_request.appointment.payment_outbox.Value after;
    private payment_request.appointment.payment_outbox.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(payment_request.appointment.payment_outbox.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = payment_request.appointment.payment_outbox.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = payment_request.appointment.payment_outbox.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(payment_request.appointment.payment_outbox.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder setBefore(payment_request.appointment.payment_outbox.Value value) {
     ...
     * @return This builder.
     */
    public payment_request.appointment.payment_outbox.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(payment_request.appointment.payment_outbox.Value.newBuilder(before));
        } else {
          setBeforeBuilder(payment_request.appointment.payment_outbox.Value.newBuilder());
        }
      }
    ...
    public payment_request.appointment.payment_outbox.Envelope.Builder setBeforeBuilder(payment_request.appointment.payment_outbox.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder setAfter(payment_request.appointment.payment_outbox.Value value) {
     ...
     * @return This builder.
     */
    public payment_request.appointment.payment_outbox.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(payment_request.appointment.payment_outbox.Value.newBuilder(after));
        } else {
          setAfterBuilder(payment_request.appointment.payment_outbox.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public payment_request.appointment.payment_outbox.Envelope.Builder setAfterBuilder(payment_request.appointment.payment_outbox.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public payment_request.appointment.payment_outbox.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder setTransaction(event.block value) {
    ...
    public payment_request.appointment.payment_outbox.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public payment_request.appointment.payment_outbox.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (payment_request.appointment.payment_outbox.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (payment_request.appointment.payment_outbox.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new payment_request.appointment.payment_outbox.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new payment_request.appointment.payment_outbox.Value();
        }
