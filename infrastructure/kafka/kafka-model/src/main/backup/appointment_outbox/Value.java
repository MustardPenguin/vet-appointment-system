...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static account_created.account.appointment_outbox.Value.Builder newBuilder() {
    return new account_created.account.appointment_outbox.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static account_created.account.appointment_outbox.Value.Builder newBuilder(account_created.account.appointment_outbox.Value.Builder other) {
    if (other == null) {
      return new account_created.account.appointment_outbox.Value.Builder();
    } else {
      return new account_created.account.appointment_outbox.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static account_created.account.appointment_outbox.Value.Builder newBuilder(account_created.account.appointment_outbox.Value other) {
    if (other == null) {
      return new account_created.account.appointment_outbox.Value.Builder();
    } else {
      return new account_created.account.appointment_outbox.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(account_created.account.appointment_outbox.Value.Builder other) {
      super(other);
      if (RecordBuilderBase.isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = other.fieldSetFlags()[0];
      }
      if (RecordBuilderBase.isValidValue(fields()[1], other.created_at)) {
        this.created_at = data().deepCopy(fields()[1].schema(), other.created_at);
        fieldSetFlags()[1] = other.fieldSetFlags()[1];
      }
      if (RecordBuilderBase.isValidValue(fields()[2], other.processed_at)) {
     ...
     * @param other The existing instance to copy.
     */
    private Builder(account_created.account.appointment_outbox.Value other) {
      super(SCHEMA$, MODEL$);
      if (RecordBuilderBase.isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder setProcessedAt(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder clearProcessedAt() {
      processed_at = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder setPayload(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder clearPayload() {
      payload = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder setVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public account_created.account.appointment_outbox.Value.Builder clearVersion() {
