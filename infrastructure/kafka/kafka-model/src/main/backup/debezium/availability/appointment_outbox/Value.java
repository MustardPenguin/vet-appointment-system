...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static debezium.availability.appointment_outbox.Value.Builder newBuilder() {
    return new debezium.availability.appointment_outbox.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static debezium.availability.appointment_outbox.Value.Builder newBuilder(debezium.availability.appointment_outbox.Value.Builder other) {
    if (other == null) {
      return new debezium.availability.appointment_outbox.Value.Builder();
    } else {
      return new debezium.availability.appointment_outbox.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static debezium.availability.appointment_outbox.Value.Builder newBuilder(debezium.availability.appointment_outbox.Value other) {
    if (other == null) {
      return new debezium.availability.appointment_outbox.Value.Builder();
    } else {
      return new debezium.availability.appointment_outbox.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(debezium.availability.appointment_outbox.Value.Builder other) {
      super(other);
      ...
      if (RecordBuilderBase.isValidValue(fields()[2], other.created_at)) {
        this.created_at = data().deepCopy(fields()[2].schema(), other.created_at);
        fieldSetFlags()[2] = other.fieldSetFlags()[2];
      }
      if (RecordBuilderBase.isValidValue(fields()[3], other.payload)) {
        this.payload = data().deepCopy(fields()[3].schema(), other.payload);
        fieldSetFlags()[3] = other.fieldSetFlags()[3];
      }
      if (RecordBuilderBase.isValidValue(fields()[4], other.version)) {
     ...
     * @param other The existing instance to copy.
     */
    private Builder(debezium.availability.appointment_outbox.Value other) {
      super(SCHEMA$, MODEL$);
      if (RecordBuilderBase.isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder clearSagaId() {
      saga_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder setPayload(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder clearPayload() {
      payload = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder setVersion(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.availability.appointment_outbox.Value.Builder clearVersion() {
