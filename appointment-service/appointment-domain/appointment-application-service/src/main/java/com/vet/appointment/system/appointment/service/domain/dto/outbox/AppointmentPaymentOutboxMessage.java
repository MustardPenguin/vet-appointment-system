...
public class AppointmentPaymentOutboxMessage {
    ...
    private AppointmentPaymentOutboxMessage(Builder builder) {
        id = builder.id;
    ...
    public static final class Builder {
        ...
        public AppointmentPaymentOutboxMessage build() {
            return new AppointmentPaymentOutboxMessage(this);
        }
    }
}
